...
?>
    ...
    <div class="grid-x">
        <div class="cell large-12 medium-12 small-12 home_hero">
            ...
            <div class="center">
                <a data-aos="flip-up"  data-aos-delay="2300" data-aos-duration="1500" href="listing_search.php" class="waves-effect z-depth-5 home_btn transition-2">Discover More</a>
