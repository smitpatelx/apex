...
?>
    ...
    <div class="grid-x">
            <div class="cell large-12 medium-12 small-12 home_hero">
                ...
                <div class="center">
                    <a data-aos="flip-up" data-aos-delay="2500"  data-aos-duration="1500" href="listing.php" class="waves-effect waves-light btn-flat z-depth-5 white-text text-darken-4 blue lighten-2 transition-1">Discover More</a>
                    <a data-aos="flip-down" data-aos-delay="2500" data-aos-duration="1500" class="modal-trigger waves-effect waves-light btn-flat z-depth-5 white-text text-darken-4 blue lighten-2 transition-1" href="#modal1">&copy; Copyright</a>
                </div>
            </div>
    </div>
