...
<script type="text/javascript">
    ...
    function PrintListing(div, i) {
        try {
            ...
            markup += "<span class='card-title activator grey-text text-darken-4'>" + listings[i].list_heading + "<i class='fas fa-ellipsis-v right'></i></span>";
            markup += "<p><a href='#' class='btn-flat waves-effect waves-block waves-light z-depth-4'>Know More</a></p>";
            markup += "</div>";
            markup += "<div class='card-reveal'>";
            markup += "<span class='card-title grey-text text-darken-4 '>Information<i class='fas fa-times right'></i></span>";
            markup += "<ul>";
