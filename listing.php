...
<div class="grid-x grid-margin-x filters_listing">
    <div class="cell medium-2 large-2 small-2">
        ...
        <select class="numberOfResults" onchange="changeResultsPerPage()">
...
<div class="grid-x grid-padding-x">
    <div class="cell medium-12 large-12 small-12 grid-x grid-margin-x small-up-2 medium-up-2 large-up-4 fuck">
        ...
        if (isset($_COOKIE['resultsPerPage'])){
            $resultsPerPage = $_COOKIE['resultsPerPage'];
            if ($_COOKIE['resultsPerPage'] == 0) {
                $offset = 0;
                $resultsPerPage = pg_num_rows($result);
            }
        }
        ...
        if (pg_num_rows($result) > 0) {
            ...
            for ($index = 0; $index < $resultsPerPage; $index++) {
                
            $row = pg_fetch_assoc($result, $index+$offset);
