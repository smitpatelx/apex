...
<script>
    ...
    function pageChange(value) {
        ...
        if (page != -1) {
            ...
            if (page == -1) {
                page = 0;
            } else if ((page+1)*resultsPerPage > listings.length) {
...
<div class="grid-x grid-margin-x ml-2 pb-2">
    <div class="cell large-1 large-offset-5">
        <a class="btn-small" onclick="pageChange(-1)"><i class="fas fa-arrow-left"></i></a>
    </div>
...
<div class="grid-x grid-padding-x ml-3">
